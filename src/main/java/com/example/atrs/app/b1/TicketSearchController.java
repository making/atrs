...
import com.example.atrs.app.b0.ReservationFlightValidator;
...
public class TicketSearchController {
	 ...
	 * 空席照会Helper。
	 */
	private final TicketSearchHelper ticketSearchHelper;
	...
	public TicketSearchController(TicketHelper ticketHelper,
		...
		this.ticketSearchHelper = ticketSearchHelper;
		this.ticketSearchValidator = ticketSearchValidator;
		this.reservationFlightValidator = reservationFlightValidator;
	}
