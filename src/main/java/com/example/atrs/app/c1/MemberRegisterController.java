...
import com.example.atrs.domain.service.c1.MemberRegisterService;
...
public class MemberRegisterController {
	...
	public MemberRegisterController(MemberRegisterService memberRegisterService,
			MemberHelper memberHelper, MemberRegisterValidator memberRegisterValidator) {
		this.memberRegisterService = memberRegisterService;
		this.memberHelper = memberHelper;
		this.memberRegisterValidator = memberRegisterValidator;
	}
